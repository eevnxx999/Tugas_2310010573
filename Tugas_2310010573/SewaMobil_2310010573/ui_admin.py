...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayoutWidget.setGeometry(QRect(140, 40, 251, 281))
        ...
        self.lineCari.setGeometry(QRect(430, 40, 381, 28))
        ...
        self.tblAdmin.setGeometry(QRect(430, 90, 381, 231))
        self.formLayoutWidget_2 = QWidget(Form)
        self.formLayoutWidget_2.setObjectName(u"formLayoutWidget_2")
        self.formLayoutWidget_2.setGeometry(QRect(140, 350, 671, 111))
